export type Cast = "porch" | "peach" | "rain" | "well" | "kirby" | "white";
...
export const PLATES: Plate[] = [
  ...
  { id: "weather", title: "red rain.", note: "same well, other weather", src: "/weather.jpg", motion: "/motion/rain.mp4", cast: "rain", seq: 1 },
  { id: "raindear", title: "red raindear.", note: "dear deer, beside", src: "/farther-well.jpg", motion: "/motion/farther-well.mp4", cast: "rain", seq: 2 },
  { id: "reach", title: "a little farther.", note: "the well", src: "/farther-well.jpg", motion: "/motion/farther-well.mp4", cast: "well", seq: 6 },
  { id: "pink-forest", title: "pink forest.", note: "rest", src: "/pink-forest.jpg", motion: "/motion/pink-forest.mp4", cast: "well", seq: 7, gate: "deer-reign" },
  ...
  { id: "blossom-white", title: "white ring.", note: "clearer", src: "/blossom-white.jpg", motion: "/motion/blossom-white.mp4", cast: "white", seq: 1 },
  { id: "blossom-real", title: "white ring.", note: "hyperreal", src: "/blossom-real.jpg", cast: "white", seq: 2 },
  { id: "blossom-mark", title: "white ring.", note: "the mark", src: "/blossom-mark.jpg", cast: "white", seq: 3 },
